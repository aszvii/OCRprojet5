...
<?php while ($events=$req->fetch()): ?>
    ...
    <div class="evtsPost">
        <p class="evtsPlaceDate">...à <em><?= htmlspecialchars($events['evts_place']) ?>, le <?= $events['date_evts_fr'] ?></em></p>
        <h3 class="evtsPostTitle"><?= htmlspecialchars($events['evts_title']) ?></h3>
...
<?php while ($events2=$req2->fetch()): ?>
    ...
    <div class="evtsPost">
        <p class="evtsPlaceDate">...à <em><?= htmlspecialchars($events2['evts_place']) ?>, le <?= $events2['date_evts_fr'] ?></em></p>
        <h3 class="evtsPostTitle"><?= htmlspecialchars($events2['evts_title']) ?></h3>
